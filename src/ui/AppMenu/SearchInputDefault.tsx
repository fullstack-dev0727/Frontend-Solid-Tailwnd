...
type SearchInputDefaultProps<P = {}> = P & {
    name: string,
    styled?: boolean
}

export const SearchInputDefault = (
    props: PropsWithChildren<SearchInputDefaultProps<ComponentProps<"div">>>
) => {
    ...
    return (
        <div onclick={onClick} class={`group flex h-7 w-56 pr-[12px] pl-[12px] cursor-pointer justify-between rounded-[4px] px-1 transition-all duration-200 bg-black/0 hover:bg-black/[0.06] active: ${activeClass()}`}>
