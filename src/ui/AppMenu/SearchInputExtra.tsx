...
type SearchInputExtraProps<P = {}> = P & {
    name: string,
    styled?: boolean
}

export const SearchInputExtra = (
    props: PropsWithChildren<SearchInputExtraProps<ComponentProps<"div">>>
) => {
    ...
    return (
        <div onclick={onClick} class={`hover: group flex h-7 w-56 pr-[12px] pl-[12px] cursor-pointer justify-between rounded-[8px] px-1 transition-all duration-200 `}>
