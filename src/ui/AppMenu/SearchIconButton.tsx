...
export const SearchIconButton: ParentComponent<SearchIconButtonProps> = (
	props
) => {
	const SearchActive = () => {
		return (
	...
	return (
		<div
			...
			class={`group flex h-7 w-7 cursor-pointer justify-between rounded-[8px] transition-all duration-200 `}
		>
