...
type SearchIconButtonExtraProps<P = {}> = P & {
    styled?: boolean
}

export const SearchIconButtonExtra = (
    props: PropsWithChildren<SearchIconButtonExtraProps<ComponentProps<"div">>>
) => {
    ...
    return (
        <div onclick={onClick} class={`group flex h-7 w-7 cursor-pointer justify-between rounded-[8px] transition-all duration-200 bg-black/0 
            ${active() ? 'bg-black/[0.1]' : ''} group-hover:bg-black/[0.06]`}>
